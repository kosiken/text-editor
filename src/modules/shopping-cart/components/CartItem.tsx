  ...
  return (
    <Box display="flex" marginBottom={4}>
        ...
        <Box display="flex" width="120px" justifyContent="space-between">
            <Button size="inline"  padding="10px" onClick={onAddOrRemove.bind(null, true)} variant="elevated">
               +
            </Button>
            <Text fontWeight="bold">
                {count}
            </Text>
            <Button variant="elevated" size="inline" padding="10px" onClick={onAddOrRemove.bind(null, false)}>
               -
            </Button>
        </Box>
